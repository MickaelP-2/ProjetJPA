...
/**
	...
	public void requeteMethode2() {
		...
		EntityTransaction transaction = em.getTransaction();
			...
			TypedQuery<Results> query = em.createQuery("SELECT rs FROM Results rs WHERE rs.tournois = :tournois ",Results.class);
			...
			if(list.size()>0) {
				...
				Accueil.txta.setText("Compétition inconnue!!");
			}
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj == executer) {
			...
			System.out.println("JRB2: "+Accueil.JRB2.isSelected());
			requeteMethode2();
		}
		else if(obj == fermer) {
