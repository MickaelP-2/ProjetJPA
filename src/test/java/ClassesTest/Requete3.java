...
/**
	...
	public void requeteMethode3() {
		...
		EntityTransaction transaction = em.getTransaction();
			...
			TypedQuery<TestGoalscorers> query = em.createQuery("SELECT gs FROM Goalscorers gs WHERE gs.team = :equipe ",TestGoalscorers.class);
			...
			TestAccueil.txta.setText(equipe+": \n");
			for(int j=0;j<nb;j++) {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj == executer) {
			...
			System.out.println("JRB3: "+TestAccueil.JRB3.isSelected());
			requeteMethode3();
		}
		else if(obj == fermer) {
