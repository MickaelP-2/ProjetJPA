...
public class TestRechercherResultats extends JFrame implements ActionListener,MouseListener{
	/**
	 * 
	 */
	...
	//
	/**
	 * attributs de la classe de recherche de résultats.
	...
	JTextField txtf1,txtf2,txtf3,txtf4,txtf5,txtf6,txtf7,txtf8,txtf9,txtf10,txtf11;//ajouter id pour les recherches
	JButton retour, effacer,rechercher; 
	TestResults RES;//pour importer la classe
	MessageAide ma;
	FenetreAffichage FA;
	//
	/**
	 * Constructeur de la classe graphique de recherche de résultats.
	 */
	public TestRechercherResultats() {
		//constructeur
		bl = new BorderLayout();
	...
	public static void main(String[] args) {
		...
		TestRechercherResultats TRR = new TestRechercherResultats();
		TRR.setVisible(true);
	}
	//
	/**
	...
	public void rechercheDate() {
		...
		Iterator<TestResults> iter = null;
		String ligne = null;
		...
		EntityTransaction transaction = em.getTransaction();
			...
			TestResults RS = new TestResults();
			if(list.size()>1) { 
	...
	public void mouseEntered(MouseEvent me) {
		...
		if(obj==jl1) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("Identifiant du match.");
			ma.setVisible(true);
		}
		else if(obj==jl11) {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj==retour) {
			...
			this.dispose();
			TestMenuResults TMR = new TestMenuResults();
			TMR.setVisible(true);
		}
		else if(obj==effacer) {
			effacer();
