...
public class TestSupprimerResultats extends JFrame implements ActionListener,MouseListener{
	/**
	 * 
	 */
	...
	public TestSupprimerResultats() {
		...
		JP3 = new JPanel();
		JP4 = new JPanel();
		label = new JLabel("Suppréssion de résultats.");
	...
	public static void main(String[] args) {
		...
		TestSupprimerResultats TSR = new TestSupprimerResultats();
		TSR.setVisible(true);
	}
	//
	/**
	...
	/**
	 * Méthode pour supprimer une entrée dans la table des résultats.
	 */
