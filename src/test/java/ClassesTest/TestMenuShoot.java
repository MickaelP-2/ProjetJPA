...
public class TestMenuShoot extends JFrame implements ActionListener,MouseListener{
	 ...
	 */
	public TestMenuShoot() {
		bl = new BorderLayout();
		gl1 = new GridLayout(5,1);
		gl2 = new GridLayout(5,1);
		label = new JLabel("Menu pour les tirs aux buts.");
	...
	public void mouseEntered(MouseEvent me) {
		...
		if(obj==jl1) {
			...
			ma.txta.setText("Pour créer résultats de tirs aux buts.");
			ma.setVisible(true);
		}
		else if(obj==jl2) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("Pour rechercher un résultats de tirs aux buts.");
			ma.setVisible(true);
		}
		else if(obj==jl3) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("Pour modifier un résultats de tirs aux buts.");
			ma.setVisible(true);
		}
		else if(obj==jl4) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("Pour supprimer un résultat de tirs au buts.");
			ma.setVisible(true);
		}
		else if(obj==jl5) {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj==creer) {
			...
			this.dispose();
			TestCreerShoot TCSH = new TestCreerShoot();
			TCSH.setVisible(true);
		}
		else if(obj==rechercher) {
			this.setVisible(false);
			this.dispose();
			TestRechercherShoot TRSH = new TestRechercherShoot();
			...
			this.setVisible(false);
			this.dispose();
			TestSupprimerShoot TSSH = new TestSupprimerShoot();
			TSSH.setVisible(true);
		}
		else if(obj == retour) {
			this.setVisible(false);
			this.dispose();
