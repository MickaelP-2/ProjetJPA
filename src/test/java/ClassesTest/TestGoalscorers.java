...
public class TestGoalscorers {
	...
	TestGoalscorers(LocalDate ddate,String hhometeam,String aawayteam, String tteam, String sscorers, String mminute, boolean oownGoal, boolean ppenalty ){
		date = ddate;
		homeTeam = hhometeam;
		awayTeam = aawayteam;
		team = tteam;
	...
	*/
	...
	public static void main(String[] args) {
		...
		TGS.setDate(local);
		TGS.setHomeTeam("Montpellier");
		TGS.setAwayTeam("Nimes");
		TGS.setTeam("Nimes");
		TGS.setScorer("Joueur1");//-> Utiliser la classe Joueurs
		TGS.setMinute("14");
		TGS.setOwnGoal(false);
		TGS.setPenalty(true);
		System.out.println("GS: "+TGS.toString());
	}
