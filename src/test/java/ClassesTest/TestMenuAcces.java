...
public class TestMenuAcces extends JFrame implements ActionListener,MouseListener{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj==retour) {
			...
			this.dispose();
			TestAccueil TACC = new TestAccueil();
			...
			this.setVisible(false);
			this.dispose();
			TestMenuResults TMRE = new TestMenuResults();
			TMRE.setVisible(true);
		}
		else if(obj==shoot) {
			this.setVisible(false);
			this.dispose();
			TestMenuShoot TMSH = new TestMenuShoot();
