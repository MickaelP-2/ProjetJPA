...
public class TestRechercherShoot extends JFrame implements ActionListener,MouseListener{
	/**
	 * 
	 */
	...
	//
	/**
	 * Attributs de la fenetre de recherche des tirs au but.
	...
	public TestRechercherShoot() {
		...
		JP2 = new JPanel();
		JP3 = new JPanel();
		label = new JLabel("Recherche de tirs aux buts.");
	...
	public void mouseEntered(MouseEvent me) {
		...
		if(obj==jl1) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("Nom de l'équipe à domicile(home team).");
			ma.setVisible(true);
		}
		else if(obj==jl3) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("identifiant des tirs au but.");
			ma.setVisible(true);
		}
		else if(obj==jl7) {
