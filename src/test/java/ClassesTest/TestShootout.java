...
public class TestShootout {
	 ...
	 * @param ffirstshooter
	 */
	TestShootout(LocalDate ddate, String hhometeam, String aawayteam, String wwinner, String ffirstshooter){
		date = ddate;
		homeTeam = hhometeam;
		awayTeam = aawayteam;
		winner = wwinner;
	...
	public static void main(String[] args) {
		...
		TestShootout SO = new TestShootout();
