...
public class TestPourcents {
	...
	//
	public TestPourcents() {
		
	}
	//
	public TestPourcents(int vic,int def,int nul,int tot,Double pourcentVic, Double pourcentDef, Double pourcentNul) {
		this.equipe = "";
		this.victoires = vic;
		this.defaites = def;
		this.nuls = nul;
	...
	public TestPourcents(String equipe, int vic,int def,int nul,int tot,Double pourcentVic, Double pourcentDef, Double pourcentNul) {
		this.equipe = equipe;
		this.victoires = vic;
		this.defaites = def;
		this.nuls = nul;
	...
	public static void main(String[] args) {
		...
		TestPourcents pour = new TestPourcents();
	 ...
	 */
	public static Comparator<TestPourcents> comparateurPourcentageVictoire = new Comparator<TestPourcents>(){
		@Override
		public int compare(TestPourcents o1, TestPourcents o2) {
			// TODO Auto-generated method stub
	 ...
	 */
	public static Comparator<TestPourcents> comparateurPourcentageDefaites = new Comparator<TestPourcents>(){
		@Override
		public int compare(TestPourcents o1, TestPourcents o2) {
			// TODO Auto-generated method stub
	 ...
	 */
	public static Comparator<TestPourcents> comparateurPourcentageNuls = new Comparator<TestPourcents>(){
		@Override
		public int compare(TestPourcents o1, TestPourcents o2) {
			// TODO Auto-generated method stub
	...
	public static Comparator<TestPourcents> comparateurVictoire = new Comparator<TestPourcents>(){
		@Override
		public int compare(TestPourcents o1, TestPourcents o2) {
			// TODO Auto-generated method stub
	...
	public static Comparator<TestPourcents> comparateurdefaites = new Comparator<TestPourcents>(){
		@Override
		public int compare(TestPourcents o1, TestPourcents o2) {
			// TODO Auto-generated method stub
