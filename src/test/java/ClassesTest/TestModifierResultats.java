...
//import FenetreAffichage;
//import utils.MessageAide;

public class TestModifierResultats extends JFrame implements ActionListener,MouseListener{
	/**
	 * 
	 */
	...
	MessageAide ma;
	FenetreAffichage FA;
	TestResults RSmodif;//Pour conserver les valeurs precedent la modification
	//
	/**
	 * Constructeur de la fenetre de modification de résultats.
	 * Composants swing, classes.
	 */
	public TestModifierResultats() {
		//constructeur
		bl = new BorderLayout();
	...
	public static void main(String[] args) {
		...
		TestModifierResultats TMR = new TestModifierResultats();
		TMR.setVisible(true);
	}
	//
	/**
