...
//attributs: date, homeTeam, awayTeam, Team, scorer, minute, ownGoal, Penalty
	 ...
	 */
public class TestRechercherScore extends JFrame implements ActionListener,MouseListener{
/**
	 * 
	 */
	...
	//
	/**
	 * Attributs de la fenetre de recherche de scores.
	...
	//
	/**
	 * Constructeur de la fenetre de recherche d'un score de buteur.
	 */
	public TestRechercherScore() {
		//constructeur
		bl = new BorderLayout();
		...
		JP3 = new JPanel();
		JP4 = new JPanel();
		label = new JLabel("Recherche de scores de buteurs.");
	...
	public void mouseEntered(MouseEvent me) {
		...
		if(obj==jl1) {
			...
			ma.yma = p.y+5;
			ma.setLocation(ma.xma,ma.yma);
			ma.txta.setText("identifinant du score.");
			ma.setVisible(true);
		}
		else if(obj==jl10) {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(obj==retour) {
			...
			else if(txtf5.getText().equals("")==false){
				rechercheJoueur();
			}
